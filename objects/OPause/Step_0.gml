...
if(Optiose == true)
{
	...
	if(select == 1)
	{
		switch(PauseCursor)
		{
			case 0: game_set_speed(60, gamespeed_fps);
					instance_activate_all();
					instance_destroy();
					break;
				 
			case 1: if(room != DForestTwo) {OSaveLoad.loadvariable = true;}
			break;
			
			case 2: room_goto(MenuRoom); break;
			
			case 3: Optiose = false; Optiosetwo = true; 
					select = 0; PauseCursor = 0;
					break;
			
			case 4: Optiose = false; warningmessage = true;
					select = 0; PauseCursor = 0;
					break;
		}
	}
	...
	if(select == 1)
	{
		...
		{	
			...
			case 4: Optiosetwo = false; Optiose = true; global.SaveVolume = true; 
					select = 0; PauseCursor = 0; 
					break;
		}
	}
